...
import cn.px.base.oshi.SystemHardwareInfo;
...
import cn.px.sys.modular.system.entity.Notice;
import cn.px.sys.modular.system.entity.User;
import cn.px.sys.modular.system.model.UploadResult;
import cn.px.sys.modular.system.service.FileInfoService;
import cn.px.sys.modular.system.service.NoticeService;
...
public class SystemController extends BaseController {
    ...
    public String userInfo(Model model) {
        ...
        if (user.getBindCode() == null) {
            ...
            try {
                ...
                snMap.put("id",userId.toString());
                snMap.put("name",user.getName());
                String sn = JSONUtil.toJsonStr(snMap);
                File codeImg = wxService.getQrcodeService().createWxaCodeUnlimit(sn, "pages/user/bind/bind");
                FileVo fv = this.sftpHelper.upload(codeImg, "code", false, true, false);
                System.out.println(fv.toString());
                user.setBindCode(this.sftpHelper.getUrl() + "/" + fv.getPath());
    ...
    public String userTreeList(Model model) {
        log.info("用户选择器");
        return "/common/peopleSelect.html";
    }
