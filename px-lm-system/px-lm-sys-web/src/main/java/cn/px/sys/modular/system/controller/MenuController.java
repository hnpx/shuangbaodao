...
import cn.px.sys.core.constant.dictmap.DeleteDict;
import cn.px.sys.core.constant.dictmap.MenuDict;
...
import cn.px.sys.modular.system.entity.Menu;
import cn.px.sys.modular.system.model.MenuDto;
import cn.px.sys.modular.system.service.MenuService;
...
public class MenuController extends BaseController {
    ...
    public ResponseData edit(MenuDto menu) {
      /*  String icon ="layui-icon"+" "+menu.getIcon();
        menu.setIcon(icon);*/
    ...
    public ResponseData getMenuInfo(@RequestParam Long menuId) {
        ...
        menuDto.setMenuType(menu.getType());
        //设置pid和父级名称
    ...
    public List<ZTreeNode> menuTreeList() {
        return this.menuService.menuTreeList(Menu.TYPE_ADMIN);
    }
    ...
    @ResponseBody
    public List<ZTreeNode> selectMenuTreeList(@RequestParam(required = false,name = "type") Integer type) {
        List<ZTreeNode> roleTreeList = this.menuService.menuTreeList(type);
