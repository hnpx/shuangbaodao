...
import cn.px.base.enums.CommonStatus;
...
import cn.px.sys.modular.system.entity.DictType;
import cn.px.sys.modular.system.mapper.DictMapper;
import cn.px.sys.modular.system.model.params.DictParam;
import cn.px.sys.modular.system.model.result.DictResult;
...
public class DictService extends ServiceImpl<DictMapper, Dict> {
    ...
    public List<ZTreeNode> dictTreeList(Long dictTypeId, Long dictId) {
        ...
        for (ZTreeNode zTreeNode : tree) {
           ...
           /* if (subIds.contains(zTreeNode.getTitle())) {
                continue;
            }*/
