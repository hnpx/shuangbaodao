...
/**
 * (SysConfigLogisticsCompany)表控制层
 *
 * @author makejava
 * @since 2020-05-28 09:28:17
 */
@RestController
@RequestMapping("sysConfigLogisticsCompany")
@Api(value = "(SysConfigLogisticsCompany)管理")
public class SysConfigLogisticsCompanyController extends BaseController<SysConfigLogisticsCompanyEntity,SysConfigLogisticsCompanyService>{

	private static final String PREFIX = "/modular/sysConfigLogisticsCompany";
	@Autowired
	...
	@ResponseBody
	public Object query(ModelMap modelMap, SysConfigLogisticsCompanyEntity params) {
	...
	@PostMapping("/update")
	@ResponseBody
	public Object update(ModelMap modelMap, SysConfigLogisticsCompanyEntity params) {
		//TODO 数据验证
	...
	@ResponseBody
	public Object del(ModelMap modelMap, SysConfigLogisticsCompanyEntity params) {
