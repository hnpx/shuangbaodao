...
public interface MenuMapper extends BaseMapper<Menu> {
     ...
     *
     * @param roleId 角色ID
     * @param type 类型 ,1:管理员;2:供应商;3:用户
     * @return
     */
    List<Long> getMenuIdsByRoleId(@Param("roleId") Long roleId, @Param("type") Integer type);
     ...
     */
    List<ZTreeNode> menuTreeList(@Param("type") Integer type);
     ...
     * @date 2017年2月19日 下午1:33:51
     */
    List<ZTreeNode> menuTreeListByMenuIds(@Param("list") List<Long> menuIds, @Param("type") Integer type);
     ...
     * @date 2017年2月19日 下午10:35:40
     */
    List<MenuNode> getMenusBySupplierRoleIds(List<Long> roleIds);
    /**
     * 根据角色获取菜单的类型列表
     *
     * @param roleIds
