...
import cn.px.base.consts.MenuStatus;
import cn.px.base.i18n.context.UserTranslationContext;
...
public class MenuService extends ServiceImpl<MenuMapper, Menu> {
    ...
    public List<Long> getMenuIdsByRoleId(Long roleId) {
        return this.baseMapper.getMenuIdsByRoleId(roleId,Menu.TYPE_ADMIN);
    }
    ...
    public List<ZTreeNode> menuTreeList(Integer type) {
        return this.baseMapper.menuTreeList(type);
    }
    ...
    public List<ZTreeNode> menuTreeListByMenuIds(List<Long> menuIds) {
        return this.baseMapper.menuTreeListByMenuIds(menuIds,Menu.TYPE_ADMIN);
    }
    ...
    public List<MenuNode> getMenusByRoleIds(List<Long> roleIds) {
        ...
        for (MenuNode menuItem : menus) {
            menuItem.setHref(ConfigListener.getConf().get("contextPath") + menuItem.getHref());
    ...
    public Menu menuSetPcode(MenuDto menuParam) {
        ...
        resultMenu.setType(menuParam.getMenuType());
