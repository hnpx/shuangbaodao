...
import cn.px.sys.core.constant.DefaultAvatar;
import cn.px.sys.core.exception.enums.BizExceptionEnum;
import cn.px.sys.modular.system.entity.FileInfo;
import cn.px.sys.modular.system.entity.User;
import cn.px.sys.modular.system.mapper.FileInfoMapper;
...
public class FileInfoService extends ServiceImpl<FileInfoMapper, FileInfo> {
    ...
    public UploadResult uploadFile(File file) {
        ...
        uploadResult.setFileSavePath(ConstantsContext.getFileUploadPath() + finalName);
        ...
        try {
            ...
            fileInfo.setFilePath(ConstantsContext.getFileUploadPath() + finalName);
            fileInfo.setFinalName(finalName);

            //计算文件大小kb
            long kb = new BigDecimal(file.length())
